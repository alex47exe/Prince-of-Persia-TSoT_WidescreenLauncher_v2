...
#AutoIt3Wrapper_Res_Description=Prince of Persia TSoT Blank Exe
...
#pragma compile(FileDescription, 'Prince of Persia TSoT Blank Exe')
#pragma compile(FileVersion, 1.1.0.47)
#pragma compile(InternalName, 'Prince of Persia TSoT Blank Exe')
#pragma compile(LegalCopyright, '2015, SalFisher47')
#pragma compile(OriginalFilename, Blank.exe)
#pragma compile(ProductName, 'Prince of Persia TSoT Blank Exe')
#pragma compile(ProductVersion, 1.1.0.47)
#EndRegion ;**** Pragma Compile ****
; === UniCrack Installer.au3 =======================================================================================================
; Title .........: Prince of Persia TSoT Blank Exe
; Version .......: 1.1.0.47
; AutoIt Version : 3.3.10.2
; Language ......: English
; Description ...: Prince of Persia TSoT Blank Exe
